...
/// page limits / margins, and reading flow orders (Boox NeoReader standard & Manga RTL) directly over the active comic page.
...
struct ComicSmartTiersQuickAdjustHUD: View {
    ...
    private func landscapeLayout(size: CGSize) -> some View {
        HStack(spacing: 16) {
            ...
            // Right Column: Header, Presets, Direction Pill, Scrollable Controls, Pinned Apply Button
            VStack(spacing: 10) {
                headerBar

                presetStrip

                readingDirectionPill
    ...
    private var readingDirectionPill: some View {
        HStack(spacing: 6) {
                ...
                ZStack(alignment: .topLeading) {
                    ...
                    if leftTrim > 0.001 || rightTrim > 0.001 || topTrim > 0.001 || botTrim > 0.001 {
                        ...
                        RoundedRectangle(cornerRadius: 4)
                            .stroke(Color.inkViolet.opacity(0.65), style: StrokeStyle(lineWidth: 1.2, dash: [4, 3]))
                    ...
                    ForEach(previewQuadrants) { quad in
                        ...
                        // In Vision coordinates, Y=0 is bottom; convert to SwiftUI top-left Y
    ...
    private var controlsView: some View {
        VStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                HStack(spacing: 6) {
                    ForEach(ComicReadingFlowOrder.allCases) { flow in
            ...
            HStack {
                ...
                Slider(value: $config.overlap, in: 0.05...0.30, step: 0.01) {
                    Text("Overlap")
                }
                .tint(.inkGreen)
                .frame(width: 120)
    ...
    private var applyButton: some View {
        Button {
            HapticEngine.medium()
            prefs.comicTierConfiguration = config
