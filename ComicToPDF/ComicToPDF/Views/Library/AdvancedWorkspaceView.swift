...
struct AdvancedWorkspaceView: View {
    ...
    @ViewBuilder
    private var goModeWarningView: some View {
        NavigationStack {
            ZStack {
                ...
                VStack(spacing: 24) {
                    ...
                    ZStack {
                        ...
                        Circle()
                            .fill(Color.inkAmber.opacity(0.15))
                        ...
                        Image(systemName: "exclamationmark.triangle.fill")
                            ...
                            .foregroundStyle(
                                LinearGradient(
                                    colors: [Color.inkAmber, Color.inkRed],
                    ...
                    Text("Enable Pro Mode to unlock the editor workspace, page deletion, reordering, chapter splitting, and guided panel generation.")
                        .font(.system(size: 15))
                    ...
                    Button {
                        ...
                        .cornerRadius(12)
                        .shadow(color: Color.inkBlue.opacity(0.35), radius: 8, y: 3)
                    }
