...
struct PanelEditorView: View {
    ...
    @State private var initialDetectedPanels: [CGRect] = [] // Γ£à Store initial AI state for learning
    ...
    var body: some View {
            ...
            GeometryReader { geo in
                ZStack {
                    ...
                    if let image = pageImage {
                        // Γ£à FIX: Add padding to prevent top cutoff
        ...
        .task {
            // Γ£à THE FIX: Check for passed image first
            if let passedImage = initialImage {
                print("ΓÜí∩╕Å Using passed image. Skipping unzip.")
    ...
    func autoDetectPanels() {
        ...
        Task {
            ...
            await MainActor.run {
                ...
                self.initialDetectedPanels = self.panels // Γ£à Checkpoint for learning
                self.isProcessing = false
            }
        }
    }
    ...
    func saveAndNavigate(offset: Int) {
        ...
        Task {
            // Γ£à Trigger Learning on Next/Prev
