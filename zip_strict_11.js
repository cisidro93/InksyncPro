...
function buildReflowableImageEpub() {
    console.log("Generating simple reflowable EPUB with IMAGE...");
    const baseDir = path.join(__dirname, 'advanced_11_dir');
...
<container version="1.0" xmlns="urn:oasis:names:tc:opendocument:xmlns:container">
  <rootfiles>
    ...
    fs.writeFileSync(path.join(baseDir, 'OEBPS', 'css', 'style.css'), `body { text-align: center; margin: 0; padding: 0; background-color: white; } img { max-width: 100%; height: auto; }`);

    // Copy the same image we used in Advanced 8/9/10
...
<package version="3.0" xmlns="http://www.idpf.org/2007/opf" unique-identifier="pub-id">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:opf="http://www.idpf.org/2007/opf">
    ...
    <dc:title>Reflowable Image Test</dc:title>
...
<body>
    <img src="images/comic_page.jpg" alt="Comic Page" />
</body>
</html>`;
    ...
    const outputPath = path.join(__dirname, 'advanced_11_reflowable_image_test.epub');
